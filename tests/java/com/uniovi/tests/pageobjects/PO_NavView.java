...
public class PO_NavView extends PO_View {
	 ...
	 * opci�n principal. * @param criterio: "id" or "class" or "text" or
	 * "@attribute" or "free". Si el valor de criterio es free es una expresion
	 * xpath completa. * @param textoDestino: texto correspondiente a la b�squeda de
	 * la p�gina destino.
	 */
	...
	public static void clickOptionByClass(WebDriver driver, String textOption, String criterio, String textoDestino) {
		// CLickamos en la opci�n de registro y esperamos a que se cargue el enlace de
		// Registro.
		List<WebElement> elementos = SeleniumUtils.EsperaCargaPagina(driver, "class", textOption, getTimeout());
		// Tiene que haber un s�lo elemento.
		assertTrue(elementos.size() == 1);
		// Ahora lo clickamos
		elementos.get(0).click();
